...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_12__dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_13__profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]] }
];
...
module.exports = "<md-card>\n    <md-grid-list cols=\"3\" rowHeight=\"200px\">\n        <md-grid-tile [colspan]=\"3\" [rowspan]=\"1\">\n            <h1>MEAN Authentication App</h1>\n            <p>Welcome to this custom MEAN Authentication app built from scratch with Material Design.</p>\n        </md-grid-tile>\n        <md-grid-tile [colspan]=\"1\" [rowspan]=\"1\">\n            <md-grid-tile-header class=\"tileHeader\">\n                <h4>Express Backend</h4>\n            </md-grid-tile-header>\n            <p>Welcome to this custom MEAN Authentication app built from scratch with Material Design.</p>\n        </md-grid-tile>\n        <md-grid-tile [colspan]=\"1\" [rowspan]=\"1\">\n            <md-grid-tile-header class=\"tileHeader\">\n                <h4>Angular-CLI</h4>\n            </md-grid-tile-header>\n            <p>Welcome to this custom MEAN Authentication app built from scratch with Material Design.</p>\n        </md-grid-tile>\n        <md-grid-tile [colspan]=\"1\" [rowspan]=\"1\">\n            <md-grid-tile-header class=\"tileHeader\">\n                <h4>JWT Tokens</h4>\n            </md-grid-tile-header>\n            <p>Welcome to this custom MEAN Authentication app built from scratch with Material Design.</p>\n        </md-grid-tile>\n    </md-grid-list>\n</md-card>\n"
...
module.exports = "<md-card>\n    <md-card-header>\n        <h1>Login</h1>\n    </md-card-header>\n    <form (submit)=\"onLoginSubmit()\" class=\"example-form\">\n        <p>\n            <md-input-container class=\"example-full-width\">\n                <input [(ngModel)]=\"username\" mdInput name=\"username\" placeholder=\"Username\" type=\"text\">\n            </md-input-container>\n        </p>\n\n        <p>\n            <md-input-container class=\"example-full-width\">\n                <input [(ngModel)]=\"password\" mdInput name=\"password\" placeholder=\"Password\" type=\"password\">\n            </md-input-container>\n        </p>\n        <button md-raised-button type=\"submit\" color=\"accent\">Submit</button>\n    </form>\n\n</md-card>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.snackBar.open('You are now logged in', action, {
                    duration: 5000
                });
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.snackBar.open(data.msg, action, {
                    duration: 5000
                });
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_material__["b" /* MdSnackBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_material__["b" /* MdSnackBar */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]) === "function" && _c || Object])
], LoginComponent);
...
module.exports = "<md-toolbar color=\"primary\">\n    <span>MEAN Auth App</span>\n    <button md-button [routerLink]=\"['/']\">Home</button>\n    <span class=\"spacer\"></span>\n    <button *ngIf=\"authService.loggedIn()\" md-button [routerLink]=\"['/dashboard']\">Dashboard</button>\n    <button *ngIf=\"authService.loggedIn()\" md-button [routerLink]=\"['/profile']\">Profile</button>\n    <button *ngIf=\"!authService.loggedIn()\" md-button [routerLink]=\"['/login']\">Login</button>\n    <button *ngIf=\"!authService.loggedIn()\" md-button [routerLink]=\"['/register']\">Register</button>\n    <button *ngIf=\"authService.loggedIn()\" md-button (click)=\"onLogoutClick()\">Logout</button>\n</md-toolbar>\n"
...
module.exports = "<md-card>\n    <md-card-header>\n        <h1>Register</h1>\n    </md-card-header>\n    <form (submit)=\"onRegisterSubmit()\" class=\"example-form\">\n        <p>\n            <md-input-container class=\"example-full-width\">\n                <input [(ngModel)]=\"name\" mdInput name=\"name\" placeholder=\"Name\" type=\"text\">\n            </md-input-container>\n        </p>\n\n        <p>\n            <md-input-container class=\"example-full-width\">\n                <input [(ngModel)]=\"username\" mdInput name=\"username\" placeholder=\"Username\" type=\"text\">\n            </md-input-container>\n        </p>\n\n        <p>\n            <md-input-container class=\"example-full-width\">\n                <input [(ngModel)]=\"email\" mdInput name=\"email\" placeholder=Email type=\"text\">\n            </md-input-container>\n        </p>\n\n        <p>\n            <md-input-container class=\"example-full-width\">\n                <input [(ngModel)]=\"password\" mdInput name=\"password\" placeholder=\"Password\" type=\"password\">\n            </md-input-container>\n        </p>\n        <button md-raised-button type=\"submit\" color=\"accent\">Submit</button>\n    </form>\n\n</md-card>\n"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                _this.snackBar.open('You are now registered and can log in', action, {
                    duration: 2000
                });
                _this.router.navigate(['/login']);
            }
            else {
                _this.snackBar.open('Something went wrong.', action, {
                    duration: 2000
                });
...
RegisterComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_validate_service__["a" /* ValidateService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__angular_material__["b" /* MdSnackBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_material__["b" /* MdSnackBar */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === "function" && _d || Object])
], RegisterComponent);
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateEmail = function (email) {
        // Makes sure email is in the format of email
